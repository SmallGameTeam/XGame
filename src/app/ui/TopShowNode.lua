...
function TopShowNode:posInit()
	...
	self.titleLabel_ = cc.ui.UILabel.new({text = "", size = 16, color = display.COLOR_WHITE,align=cc.ui.TEXT_ALIGN_LEFT}):addTo(self,1)
	...
	self.amountLabel_ = cc.ui.UILabel.new({text = "", size = 16, color = display.COLOR_GREEN,align=cc.ui.TEXT_ALIGN_LEFT}):addTo(self,1)
